  ...
  return (
    ...
    >
      <span className={cn("text-gray-600 pr-1", makeMultiLine && "pr-0 pb-1")}>
        {process.env.NEXT_PUBLIC_APP_TITLE} and the check folder logo are trademarks of {process.env.NEXT_PUBLIC_APP_TITLE} Inc. © {new Date().getFullYear()} {process.env.NEXT_PUBLIC_APP_TITLE} Inc. All rights reserved.
      </span>
